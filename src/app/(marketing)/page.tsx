    ...
    <>
      ...
      <header id="header">
        <div className="container header-content">
          ...
          <a href="#contact" className="btn btn-primary" style={{ padding: "0.5rem 1rem", fontSize: "0.8rem" }}>Iniciar proyecto</a>
        </div>
      </header>
          ...
          <div className="pipeline-container">
            ...
            >
              ...
              <div className="pipeline-content">
                ...
                <p className="pipeline-desc">Te hacemos 5 preguntas clave sobre tu negocio y empezamos a trabajar.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="pipeline-content">
                ...
                <p className="pipeline-desc">La IA hace el trabajo pesado, nosotros lo supervisamos para que todo quede perfecto.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="pipeline-content">
                ...
                <p className="pipeline-desc">Revisamos cada detalle a mano antes de entregarte tu web lista y publicada.</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      >
        <div className="container">
          ...
          <div className="hexagon-container">
            <div className="hexagon-bg-text">INGENIERÍA</div>
      ...
      >
        <div className="container">
          ...
          <p style={{ textAlign: "center", color: "var(--text-muted)", marginBottom: "3rem", marginTop: "-2rem" }}>
            Mira lo que podemos hacer por tu negocio. Cada proyecto está optimizado para atraer clientes.
          </p>
          ...
          <div className="mono-text" style={{ color: 'var(--text-muted)', fontSize: '0.8rem', marginBottom: '2rem', textAlign: 'center', maxWidth: '800px', margin: '0 auto 2rem auto' }}>
            &gt; Proyectos reales diseñados para negocios como el tuyo.
          </div>
            ...
            {MODULAR_ENGINEERING_DEMOS.map((demo, idx) => (
              <div key={idx} className="portfolio-card demo-isolate group" style={{ background: 'var(--bg-card)', borderRadius: '12px', border: '1px solid rgba(100, 255, 218, 0.1)', overflow: 'hidden', position: 'relative' }}>
                ...
                <div className="portfolio-item transform-gpu relative w-full h-full min-h-[250px] overflow-hidden">
                  ...
                  />
                  <div
                    className="portfolio-overlay absolute inset-0 bg-black/60 opacity-100 flex flex-col justify-center items-center p-6 text-center transform translate-y-0 group-hover:bg-black/40 transition-all"
                    style={{ zIndex: 2 }}
                  >
                    ...
                    <a href={demo.link} target="_blank" className="btn btn-primary transform-gpu" style={{ padding: '0.6rem 1.2rem', fontSize: '0.7rem' }}>Ver proyecto</a>
                  </div>
                </div>
              </div>
            ))}
